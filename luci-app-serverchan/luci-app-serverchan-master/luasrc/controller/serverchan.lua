...
function index()
	...
	entry({"admin", "services", "serverchan"}, alias("admin", "services", "serverchan", "setting"),_("WeChat push"), 30).dependent = true
	entry({"admin", "services", "serverchan", "setting"}, cbi("serverchan/setting"),_("Configuration"), 40).leaf = true
	entry({"admin", "services", "serverchan", "advanced"}, cbi("serverchan/advanced"),_("advanced settings"), 50).leaf = true
	entry({"admin", "services", "serverchan", "client"}, form("serverchan/client"), "Online device", 80)
	entry({"admin", "services", "serverchan", "log"}, form("serverchan/log"),_("Log"), 99).leaf = true
